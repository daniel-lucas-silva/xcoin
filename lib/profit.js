  ...
  return {
    getProfitStopPrice: function (symbol) {
      ...
      if (
        ...
        s.options.profit_stop_max_rate / 100
      ) {
        profit_stop =
          (s.symbols[symbol.product_id].profit_stop_high *
            s.options.profit_stop_max_percent) /
          100
      } else if (
        s.symbols[symbol.product_id].profit_stop_high >
        s.options.profit_stop_third_rate / 100
      ) {
        profit_stop =
          (s.symbols[symbol.product_id].profit_stop_high *
            s.options.profit_stop_third_percent) /
          100
      } else if (
        s.symbols[symbol.product_id].profit_stop_high >
        s.options.profit_stop_second_rate / 100
      ) {
        profit_stop =
          (s.symbols[symbol.product_id].profit_stop_high *
            s.options.profit_stop_second_percent) /
          100
      } else if (
        s.symbols[symbol.product_id].profit_stop_high >
        s.options.profit_stop_first_rate / 100
      ) {
        profit_stop =
          (s.symbols[symbol.product_id].profit_stop_high *
            s.options.profit_stop_first_percent) /
          100
      }
      return profit_stop
    },
    ...
    checkProfitWin: function (symbol) {
      ...
      if (
        ...
        s.options.profit_win_first_rate &&
        s.symbols[symbol.product_id].last_trade_worth >=
          s.options.profit_win_first_rate / 100
      ) {
        stop_signal = true
        ...
        s.symbols[symbol.product_id].last_sell_type =
          'profit_win_first_sell_' +
          (s.symbols[symbol.product_id].last_buy_type &&
          s.symbols[symbol.product_id].last_buy_type.indexOf('short') >= 0
            ? 'short'
            : 'long')
      } else if (
        !s.symbols[symbol.product_id].has_profit_win_second_sell &&
        s.symbols[symbol.product_id].action &&
        (s.symbols[symbol.product_id].action === 'partSell' ||
          s.symbols[symbol.product_id].action === 'bought') &&
        s.options.profit_win_second_rate &&
        s.symbols[symbol.product_id].last_trade_worth >=
          s.options.profit_win_second_rate / 100
      ) {
        stop_signal = true
        ...
        s.symbols[symbol.product_id].inSignal =
          ...
          s.symbols[symbol.product_id].last_buy_type.indexOf('short') >= 0
            ...
            : 'long'
        s.symbols[symbol.product_id].last_sell_type =
          'profit_win_second_sell_' +
          (s.symbols[symbol.product_id].last_buy_type &&
          s.symbols[symbol.product_id].last_buy_type.indexOf('short') >= 0
            ? 'short'
            : 'long')
      } else if (
        !s.symbols[symbol.product_id].has_profit_win_third_sell &&
        s.symbols[symbol.product_id].action &&
        (s.symbols[symbol.product_id].action === 'partSell' ||
          s.symbols[symbol.product_id].action === 'bought') &&
        s.options.profit_win_third_rate &&
        s.symbols[symbol.product_id].last_trade_worth >=
          s.options.profit_win_third_rate / 100
      ) {
        stop_signal = true
        ...
        s.symbols[symbol.product_id].inSignal =
          ...
          s.symbols[symbol.product_id].last_buy_type.indexOf('short') >= 0
            ...
            : 'long'
        s.symbols[symbol.product_id].last_sell_type =
          'profit_win_third_sell_' +
          (s.symbols[symbol.product_id].last_buy_type &&
          s.symbols[symbol.product_id].last_buy_type.indexOf('short') >= 0
            ? 'short'
            : 'long')
      } else if (
        !s.symbols[symbol.product_id].has_profit_win_max_sell &&
        s.symbols[symbol.product_id].action &&
        (s.symbols[symbol.product_id].action === 'partSell' ||
          s.symbols[symbol.product_id].action === 'bought') &&
        s.options.profit_win_max_rate &&
        s.symbols[symbol.product_id].last_trade_worth >=
          s.options.profit_win_max_rate / 100
      ) {
        stop_signal = true
